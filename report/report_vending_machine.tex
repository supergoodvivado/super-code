...
LED1 用于订单状态和异常提示，LED2、LED3、LED4 分别指示付款、出货和找零/退款。缺货、付款不足、金额超限以及订单已经包含两种商品后再次添加时，LED1 闪烁两次并配合蜂鸣器提示；管理员模式下 LED4 常亮。这样即使第一件商品缺货、当前订单数量仍为零，缺货提示也不会被订单状态逻辑屏蔽。
